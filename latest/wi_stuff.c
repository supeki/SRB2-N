...
static patch_t*         nowhyper; // Nozomi 03-19-2026
...
//    byte*       colormap;   //added:08-02-98: remap STBP0 to player color
	...
	{
		V_DrawString(72,32, va("%s * %d *", mapheaders[gamemap].name, mapheaders[gamemap].act));
...
//        sprintf(bgname, "WIMAP%d", wbs->epsd);
	...
	nowhyper = W_CachePatchName("NOWHYPER", PU_STATIC); // Nozomi 03-19-2026
...
void WI_unloadData(void)
{
	...
	Z_ChangeTag(nowhyper, PU_CACHE); // Nozomi 03-19-2026
