...
void P_PlayerInSpecialSector (player_t* player)
{
	...
	if(player->specialsector == 983 || player->specialsector == 984) // Slime! Tails 04-15-2001
	{
		if(player->mo->z+player->mo->height/4 < player->mo->waterz && !player->powers[pw_greenshield])
			P_DamageMobj(player->mo, NULL, NULL, DMG_SLIME);
		return;
	}
...
// End THZ2-specific Slime Raise button Tails 04-19-2001
    ...
    if(player->specialsector < 32) //SoM: 3/8/2000: Regular sector specials.
      ...
      // Has hitten ground.
		switch (player->specialsector)
		{
			case 4: // Does nothing? Nozomi 03-17-2026
			//        P_DamageMobj (player->mo, NULL, NULL, 1);
			break;

			case 5: // Death Pit Nozomi 03-17-2026
			...
			case 9: // Secret Sector Nozomi 03-17-2026
				player->secretcount++;
				sector->special = 0;
			break;

			case 16: // Death Pit Nozomi 03-17-2026
				if (gameskill == sk_baby) {
					player->mo->z++;
					player->mo->momz = JUMPGRAVITY*5;
					P_SetMobjState(player->mo, S_PLAY_FALL1);
