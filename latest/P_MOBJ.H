...
//-----------------------------------------------------------------------------
//
// $Id: p_mobj.h,v 1.4 2000/04/30 10:30:10 bpereira Exp $
//
...
typedef enum
{
    ...
    MF_TRANSLATION      = 0x4000000,    // 0xc000000, original 4color
...
typedef enum
{
    ...
    MF_NOZCHECKING       = 32,
    // don't show it, is for player mobj only spirit is shown
    MF_INVISIBLE         = 64,
	// this object is sprung,,, Nozomi 03-19-2026
	MF_SPRUNG			 = 128
} mobjeflag_t;
...
typedef struct mobj_s
{
    ...
    // WARNING : new field are not automatically added to save game 
    //SOM: Added fuse
    int                 fuse;
