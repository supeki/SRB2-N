...
//-----------------------------------------------------------------------------
//
// $Id: win_dbg.c,v 1.5 2000/08/03 17:57:42 bpereira Exp $
//
...
// Save 21-03-2026
    ...
    FPrintf (fileHandle, "Email this file to admin@maril.dev so I can (try to) fix the bugs.\r\n"); // Nozomi
    FPrintf (fileHandle, "Please tell me what you did to cause the crash, and if possible, record a demo!\r\n"); // Nozomi
    FPrintf (fileHandle, "\r\n");
    FPrintf (fileHandle, "Sonic Robo Blast 2 \"Nozomi\" %s -ERROR LOG-\r\n", VERSIONSTRING);
