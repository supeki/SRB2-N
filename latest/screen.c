...
void SCR_SetSCRMode (void) {
	COM_BufAddText("vid_mode ");
	COM_BufAddText(va("%d", cv_scr_mode.value));
	COM_BufAddText("\n");
}
...
void SCR_SetMode (void)
{
    ...
    if (vid.bpp>1)
    {
		...
		transtransfunc = R_DrawTranslatedColumn_16;
...
void SCR_SetDefaultMode (void)
{
	...
	CV_SetValue (&cv_scr_mode,  vid.modenum);
