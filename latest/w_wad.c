...
int W_LoadWadFile (char *filename)
{
	...
	if(strncmp(header.identification, "IWAD", 4)
		...
		&& strncmp(header.identification, "MARL", 4))
	{
    ...
    wadfile->timestamp = bufstat.st_mtime;
...
// making a copy of the above for music purposes so we don't crash just because someone put the wrong music lump name Nozomi 03-05-2026
int W_GetNumForNameMusic (char* name)
{
    int i;
